...
final class EntityController1_21_R1 implements EntityController {
   ...
   public EntityController1_21_R1(Mob m) {
      EntityInsentient nms = ChipUtil1_21_R1.toNMS(m);
      this.lookC = nms.I();
      this.moveC = nms.J();
      this.jumpC = nms.L();
      this.m = m;
