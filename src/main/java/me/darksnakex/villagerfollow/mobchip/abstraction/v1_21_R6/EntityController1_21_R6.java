...
final class EntityController1_21_R6 implements EntityController {
   ...
   public EntityController1_21_R6(Mob m) {
      EntityInsentient nms = ChipUtil1_21_R6.toNMS(m);
      this.lookC = nms.P();
      this.moveC = nms.Q();
      this.jumpC = nms.R();
      this.m = m;
   ...
   public Vector getDeltaMovement() {
      ...
      return new Vector(delta.g, delta.h, delta.i);
   }
