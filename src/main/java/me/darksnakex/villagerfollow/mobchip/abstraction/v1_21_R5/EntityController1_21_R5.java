...
final class EntityController1_21_R5 implements EntityController {
   ...
   public EntityController1_21_R5(Mob m) {
      EntityInsentient nms = ChipUtil1_21_R5.toNMS(m);
      this.lookC = nms.P();
      this.moveC = nms.Q();
      this.jumpC = nms.R();
      this.m = m;
   ...
   public EntityController moveTo(double x, double y, double z, double speedMod) {
      ...
      this.moveC.a();
      this.nms.S().a(this.moveC.d(), this.moveC.e(), this.moveC.f(), this.moveC.c());
      this.nms.S().d();
      return this;
   }
