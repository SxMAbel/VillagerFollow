...
final class EntityBody1_19_R3 implements EntityBody {
   ...
   public EntityBody1_19_R3(Mob m) {
      this.m = m;
      this.nmsMob = ChipUtil1_19_R3.toNMS(m);
   }
   ...
   public EntityBody.InteractionResult interact(@NotNull Player p, @Nullable EntityBody.InteractionHand hand) {
      ...
      switch(this.nmsMob.a(ChipUtil1_19_R3.toNMS(p), h)) {
      case a:
   ...
   public boolean isInvisibleTo(@Nullable Player p) {
      return this.nmsMob.d(ChipUtil1_19_R3.toNMS(p));
   }
   ...
   public boolean isMoving() {
      double x = this.nmsMob.dl() - this.nmsMob.I;
      double z = this.nmsMob.dr() - this.nmsMob.K;
   ...
   public void setBodyRotation(float rotation) {
      this.nmsMob.aT = EntityBody.normalizeRotation(rotation);
   }
   ...
   public void playAnimation(@NotNull EntityAnimation anim) {
      ...
      case CRITICAL_DAMAGE:
         ...
         var3 = ChipUtil1_19_R3.fromNMS(this.nmsMob).getWorld().getPlayers().iterator();

         while(var3.hasNext()) {
            p = (Player)var3.next();
            ChipUtil1_19_R3.toNMS(p).b.a(pkt);
         }
   ...
   public boolean isInvulnerableTo(@Nullable DamageCause cause) {
      return this.nmsMob.b(ChipUtil1_19_R3.toNMS((DamageCause)cause, (Entity)this.m));
   }
   ...
   public void setYaw(float rotation) {
      this.nmsMob.f(EntityBody.normalizeRotation(rotation));
   }
   ...
   public void setPitch(float rotation) {
      this.nmsMob.e(EntityBody.normalizeRotation(rotation));
   }
   ...
   public void eat(@NotNull ItemStack item) {
      this.nmsMob.a(ChipUtil1_19_R3.toNMS(this.m.getWorld()), ChipUtil1_19_R3.toNMS(item));
   }

   public void setRotation(float yaw, float pitch) {
      try {
         if (this.m instanceof Slime) {
            ControllerMove moveControl = this.nmsMob.D();
