...
final class EntityController1_21_R4 implements EntityController {
   ...
   public EntityController1_21_R4(Mob m) {
      EntityInsentient nms = ChipUtil1_21_R4.toNMS(m);
      this.lookC = nms.I();
      this.moveC = nms.K();
      this.jumpC = nms.M();
      this.m = m;
   ...
   public EntityController moveTo(double x, double y, double z, double speedMod) {
      ...
      this.moveC.a();
      this.nms.N().a(this.moveC.d(), this.moveC.e(), this.moveC.f(), this.moveC.c());
      this.nms.N().c();
      return this;
   }
   ...
   public Vector getDeltaMovement() {
      Vec3D delta = this.nms.dy();
      return new Vector(delta.d, delta.e, delta.f);
   }
