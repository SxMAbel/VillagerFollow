...
final class EntityBody1_21_R5 implements EntityBody {
   ...
   public EntityBody.InteractionResult interact(@NotNull Player p, @Nullable EntityBody.InteractionHand hand) {
      ...
      EnumInteractionResult result = this.nmsMob.a(ChipUtil1_21_R5.toNMS(p), h);
   ...
   public boolean isInvisibleTo(@Nullable Player p) {
      return this.nmsMob.f(ChipUtil1_21_R5.toNMS(p));
   }

   @NotNull
   public EntityBody.InteractionHand getMainHand() {
      return this.nmsMob.fF() == EnumMainHand.a ? EntityBody.InteractionHand.OFF_HAND : EntityBody.InteractionHand.MAIN_HAND;
   }
   ...
   public boolean isMoving() {
      ...
      double z = this.nmsMob.dI() - this.nmsMob.Z;
   ...
   public void playAnimation(@NotNull EntityAnimation anim) {
      ...
      case CRITICAL_DAMAGE:
         ...
         var3 = ChipUtil1_21_R5.fromNMS(this.nmsMob).getWorld().getPlayers().iterator();

         while(var3.hasNext()) {
            p = (Player)var3.next();
            ChipUtil1_21_R5.toNMS(p).g.b(pkt);
         }
   ...
   public boolean isInvulnerableTo(@Nullable DamageCause cause) {
      return this.nmsMob.a(this.nmsMob.ai().getMinecraftWorld(), ChipUtil1_21_R5.toNMS((DamageCause)cause, (Entity)this.m));
   }
   ...
   public boolean isPushableBy(@Nullable Entity entity) {
      return IEntitySelector.a(ChipUtil1_21_R5.toNMS(entity)).test(ChipUtil1_21_R5.toNMS(entity));
   }
   ...
   public void sendTo(@NotNull Player p) {
      EntityTracker tracked = (EntityTracker)((WorldServer)this.nmsMob.ai()).n().a.L.get(this.nmsMob.ar());
   ...
   public void eat(@NotNull ItemStack item) {
      this.nmsMob.ai().a((net.minecraft.world.entity.Entity)null, this.nmsMob.dC(), this.nmsMob.dE(), this.nmsMob.dI(), SoundEffects.kQ, this.nmsMob.do(), 1.0F, 1.0F);
