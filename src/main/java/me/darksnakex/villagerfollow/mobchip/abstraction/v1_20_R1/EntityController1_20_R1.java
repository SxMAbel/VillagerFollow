...
final class EntityController1_20_R1 implements EntityController {
   ...
   public EntityController1_20_R1(Mob m) {
      EntityInsentient nms = ChipUtil1_20_R1.toNMS(m);
      this.lookC = nms.E();
      this.moveC = nms.G();
      this.jumpC = nms.I();
      this.m = m;
   ...
   public EntityController moveTo(double x, double y, double z, double speedMod) {
      ...
      this.moveC.a();
      this.nms.J().a(this.moveC.d(), this.moveC.e(), this.moveC.f(), this.moveC.c());
      this.nms.J().c();
      return this;
   }
