...
final class EntityController1_19_R3 implements EntityController {
   ...
   public EntityController1_19_R3(Mob m) {
      EntityInsentient nms = ChipUtil1_19_R3.toNMS(m);
      this.lookC = nms.C();
      this.moveC = nms.D();
      this.jumpC = nms.E();
      this.m = m;
   ...
   public EntityController moveTo(double x, double y, double z, double speedMod) {
      ...
      this.moveC.a();
      this.nms.G().a(this.moveC.d(), this.moveC.e(), this.moveC.f(), this.moveC.c());
      this.nms.G().c();
      return this;
   }
