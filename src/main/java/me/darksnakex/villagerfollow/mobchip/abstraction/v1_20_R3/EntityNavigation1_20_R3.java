...
final class EntityNavigation1_20_R3 implements EntityNavigation {
   ...
   public EntityNavigation1_20_R3(Mob m) {
      this.handle = ChipUtil1_20_R3.toNMS(m).N();
   ...
   public NavigationPath buildPath() {
      if (this.points.isEmpty()) {
         ...
         return new NavigationPath1_20_R3(new PathEntity(this.toNodes(), (BlockPosition)null, true), this.m, (double)this.speedMod);
      }
   }
