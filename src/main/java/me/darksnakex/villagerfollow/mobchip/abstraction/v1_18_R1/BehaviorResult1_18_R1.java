...
final class BehaviorResult1_18_R1 extends BehaviorResult {
   ...
   public BehaviorResult1_18_R1(Behavior<? super EntityLiving> b, EntityInsentient mob) {
      this.b = b;
      this.mob = mob;
      this.l = ChipUtil1_18_R1.toNMS(Bukkit.getWorld(mob.t.getWorld().getUID()));
      b.e(this.l, mob, 0L);
   }

   @NotNull
   public BehaviorResult.Status getStatus() {
      return ChipUtil1_18_R1.fromNMS(this.b.a());
   }
