...
final class Attribute1_19_R1 extends AttributeRanged implements Attribute {
   private final NamespacedKey key;
   private final double defaultV;
   private final double min;
   private final double max;

   public Attribute1_19_R1(AttributeRanged a) {
      super(a.c(), a.a(), a.d(), a.e());
      this.key = IRegistry.ak.b(a) == null ? NamespacedKey.minecraft(a.c()) : CraftNamespacedKey.fromMinecraft(IRegistry.ak.b(a));
      this.defaultV = a.a();
      this.min = a.d();
      this.max = a.e();
   }
