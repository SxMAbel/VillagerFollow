...
final class BehaviorResult1_21_R3 extends BehaviorResult {
   private final BehaviorControl b;
   private final EntityLiving mob;
   private final WorldServer l;

   public <T extends EntityLiving> BehaviorResult1_21_R3(BehaviorControl<T> b, T mob) {
      this.b = b;
      this.mob = mob;
      this.l = ChipUtil1_21_R3.toNMS(Bukkit.getWorld(mob.cU().getWorld().getUID()));
      b.e(this.l, mob, 0L);
   }

   @NotNull
   public BehaviorResult.Status getStatus() {
      return ChipUtil1_21_R3.fromNMS(this.b.a());
   }
