...
final class BehaviorResult1_19_R3 extends BehaviorResult {
   ...
   public <T extends EntityLiving> BehaviorResult1_19_R3(BehaviorControl<T> b, T mob) {
      this.b = b;
      this.mob = mob;
      this.l = ChipUtil1_19_R3.toNMS(Bukkit.getWorld(mob.H.getWorld().getUID()));
      b.e(this.l, mob, 0L);
   }

   @NotNull
   public BehaviorResult.Status getStatus() {
      return ChipUtil1_19_R3.fromNMS(this.b.a());
   }
