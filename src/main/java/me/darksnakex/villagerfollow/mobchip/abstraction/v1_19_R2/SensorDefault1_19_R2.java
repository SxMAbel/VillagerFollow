...
final class SensorDefault1_19_R2 implements Sensor<LivingEntity> {
   ...
   public void run(@NotNull World w, LivingEntity entity) {
      try {
         ...
         doTick.invoke(this.handle, ChipUtil1_19_R2.toNMS(w), ChipUtil1_19_R2.toNMS(entity));
   ...
   public NamespacedKey getKey() {
      ...
      BuiltInRegistries.C.s().filter((s) -> {
         ...
         key.set(ChipUtil1_19_R2.fromNMS(BuiltInRegistries.C.b(s)));
      });
