...
final class EntityBody1_19_R1 implements EntityBody {
   ...
   public EntityBody.InteractionResult interact(@NotNull Player p, @Nullable EntityBody.InteractionHand hand) {
      ...
      switch(this.nmsMob.a(ChipUtil1_19_R1.toNMS(p), h)) {
      case a:
   ...
   public boolean isInvisibleTo(@Nullable Player p) {
      return this.nmsMob.c(ChipUtil1_19_R1.toNMS(p));
   }

   @NotNull
   public EntityBody.InteractionHand getMainHand() {
      return this.nmsMob.eS() == EnumMainHand.a ? EntityBody.InteractionHand.OFF_HAND : EntityBody.InteractionHand.MAIN_HAND;
   }
   ...
   public boolean isMoving() {
      double x = this.nmsMob.df() - this.nmsMob.t;
      double z = this.nmsMob.dl() - this.nmsMob.v;
   ...
   public void playAnimation(@NotNull EntityAnimation anim) {
      ...
      case CRITICAL_DAMAGE:
         ...
         var3 = ChipUtil1_19_R1.fromNMS(this.nmsMob).getWorld().getPlayers().iterator();

         while(var3.hasNext()) {
            p = (Player)var3.next();
            ChipUtil1_19_R1.toNMS(p).b.a(pkt);
         }
   ...
   public boolean isInBubbleColumn() {
      return this.nmsMob.s.a_(this.nmsMob.da()).a(Blocks.lO);
   }

   public boolean isInvulnerableTo(@Nullable DamageCause cause) {
      return this.nmsMob.b(ChipUtil1_19_R1.toNMS(cause));
   }
   ...
   public boolean isPushableBy(@Nullable Entity entity) {
      return IEntitySelector.a(ChipUtil1_19_R1.toNMS(entity)).test(ChipUtil1_19_R1.toNMS(entity));
   }
   ...
   public void eat(@NotNull ItemStack item) {
      this.nmsMob.a(ChipUtil1_19_R1.toNMS(this.m.getWorld()), ChipUtil1_19_R1.toNMS(item));
   }
