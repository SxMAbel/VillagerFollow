...
final class EntityScheduleManager1_21_R4 implements EntityScheduleManager {
   private final EntityInsentient nmsMob;

   public EntityScheduleManager1_21_R4(Mob m) {
      this.nmsMob = ChipUtil1_21_R4.toNMS(m);
   }

   @Nullable
   public Schedule getCurrentSchedule() {
      return ChipUtil1_21_R4.fromNMS(this.nmsMob.ec().c());
   }

   public void setSchedule(@NotNull Schedule s) {
      this.nmsMob.ec().a(ChipUtil1_21_R4.toNMS(s));
   }

   @NotNull
   public Set<Activity> getActiveActivities() {
      return (Set)this.nmsMob.ec().d().stream().map(ChipUtil1_21_R4::fromNMS).collect(Collectors.toSet());
   }

   public void setDefaultActivity(@NotNull Activity a) {
      this.nmsMob.ec().b(ChipUtil1_21_R4.toNMS(a));
   }
   ...
   public void setRunningActivity(@NotNull Activity a) {
      this.nmsMob.ec().a(ChipUtil1_21_R4.toNMS(a));
   }

   @Nullable
   public Activity getRunningActivity() {
      return this.nmsMob.ec().g().isPresent() ? ChipUtil1_21_R4.fromNMS((net.minecraft.world.entity.schedule.Activity)this.nmsMob.ec().g().get()) : null;
   }

   public boolean isRunning(@NotNull Activity a) {
      return this.nmsMob.ec().c(ChipUtil1_21_R4.toNMS(a));
   }
   ...
   public Consumer<Mob> put(@NotNull Activity key, Consumer<Mob> value) {
      this.nmsMob.ec().a(ChipUtil1_21_R4.toNMS(key), 0, ImmutableList.of(ChipUtil1_21_R4.toNMS(value)));
      return value;
   }
