...
final class Attribute1_18_R1 extends AttributeRanged implements Attribute {
   private final NamespacedKey key;
   private final double defaultV;
   private final double min;
   private final double max;

   public Attribute1_18_R1(AttributeRanged a) {
      super(a.c(), a.a(), a.d(), a.e());
      this.key = IRegistry.am.b(a) == null ? NamespacedKey.minecraft(a.c()) : CraftNamespacedKey.fromMinecraft(IRegistry.am.b(a));
      this.defaultV = a.a();
      this.min = a.d();
      this.max = a.e();
   }
