...
final class EntityScheduleManager1_19_R3 implements EntityScheduleManager {
   ...
   public EntityScheduleManager1_19_R3(Mob m) {
   ...
   public void setSchedule(@NotNull Schedule s) {
      this.nmsMob.dH().a(ChipUtil1_19_R3.toNMS(s));
   }
   ...
   public void setDefaultActivity(@NotNull Activity a) {
      this.nmsMob.dH().b(ChipUtil1_19_R3.toNMS(a));
   }
   ...
   public void setRunningActivity(@NotNull Activity a) {
      this.nmsMob.dH().a(ChipUtil1_19_R3.toNMS(a));
   }

   @Nullable
   public Activity getRunningActivity() {
      return this.nmsMob.dH().g().isPresent() ? ChipUtil1_19_R3.fromNMS((net.minecraft.world.entity.schedule.Activity)this.nmsMob.dH().g().get()) : null;
   }

   public boolean isRunning(@NotNull Activity a) {
      return this.nmsMob.dH().c(ChipUtil1_19_R3.toNMS(a));
   }
   ...
   public Consumer<Mob> put(@NotNull Activity key, Consumer<Mob> value) {
      this.nmsMob.dH().a(ChipUtil1_19_R3.toNMS(key), 0, ImmutableList.of(ChipUtil1_19_R3.toNMS(value)));
      return value;
   }
