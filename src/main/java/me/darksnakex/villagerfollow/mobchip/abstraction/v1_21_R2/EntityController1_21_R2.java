...
final class EntityController1_21_R2 implements EntityController {
   ...
   public EntityController1_21_R2(Mob m) {
      EntityInsentient nms = ChipUtil1_21_R2.toNMS(m);
      this.lookC = nms.H();
      this.moveC = nms.I();
      this.jumpC = nms.J();
      this.m = m;
