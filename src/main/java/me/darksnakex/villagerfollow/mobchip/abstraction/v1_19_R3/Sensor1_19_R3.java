...
final class Sensor1_19_R3 extends Sensor<EntityLiving> {
   private final me.darksnakex.villagerfollow.mobchip.ai.sensing.Sensor<?> s;

   public Sensor1_19_R3(me.darksnakex.villagerfollow.mobchip.ai.sensing.Sensor<?> s) {
      this.s = s;
   }

   protected void a(WorldServer level, EntityLiving en) {
      this.s.run(ChipUtil1_19_R3.fromNMS((World)level), ChipUtil1_19_R3.fromNMS(en));
   }
