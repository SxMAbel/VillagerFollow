...
final class EntityNavigation1_20_R2 implements EntityNavigation {
   ...
   public EntityNavigation1_20_R2(Mob m) {
      this.handle = ChipUtil1_20_R2.toNMS(m).L();
   ...
   public NavigationPath buildPath() {
      if (this.points.isEmpty()) {
         ...
         return new NavigationPath1_20_R2(new PathEntity(this.toNodes(), (BlockPosition)null, true), this.m, (double)this.speedMod);
      }
   }
