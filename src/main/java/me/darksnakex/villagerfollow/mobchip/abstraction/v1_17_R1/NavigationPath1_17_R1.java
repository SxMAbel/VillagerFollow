...
final class NavigationPath1_17_R1 implements NavigationPath {
   ...
   public NavigationPath1_17_R1(@NotNull PathEntity nms, @NotNull Mob m, double speedMod) {
      ...
      try {
         ...
         this.nodes.addAll((Collection)pathPoints.stream().map(ChipUtil1_17_R1::fromNMS).collect(Collectors.toSet()));
   ...
   public void advance() {
      if (this.isDone()) {
         ...
         (new EntityController1_17_R1(this.m)).moveTo((double)n.a, (double)n.b, (double)n.c, this.speedMod);
         this.getHandle().a();
      }
   }
