...
final class EntityBody1_20_R4 implements EntityBody {
   private final EntityInsentient nmsMob;
   private final Mob m;

   public EntityBody1_20_R4(Mob m) {
      this.m = m;
      this.nmsMob = ChipUtil1_20_R4.toNMS(m);
   }

   private void update() {
      PacketPlayOutEntityMetadata packet = new PacketPlayOutEntityMetadata(this.nmsMob.al(), this.nmsMob.ap().b());
   ...
   public boolean canBreatheUnderwater() {
      return this.nmsMob.dV();
   }

   public boolean shouldDiscardFriction() {
      return this.nmsMob.er();
   }
   ...
   public EntityBody.InteractionResult interact(@NotNull Player p, @Nullable EntityBody.InteractionHand hand) {
      ...
      switch(this.nmsMob.a(ChipUtil1_20_R4.toNMS(p), h)) {
      case a:
   ...
   public boolean isInvisibleTo(@Nullable Player p) {
      return this.nmsMob.d(ChipUtil1_20_R4.toNMS(p));
   }

   @NotNull
   public EntityBody.InteractionHand getMainHand() {
      return this.nmsMob.fu() == EnumMainHand.a ? EntityBody.InteractionHand.OFF_HAND : EntityBody.InteractionHand.MAIN_HAND;
   }
   ...
   public boolean isInCombat() {
      try {
         ...
         return inCombatF.getBoolean(this.nmsMob.bT);
   ...
   public boolean isMoving() {
      double x = this.nmsMob.du() - this.nmsMob.L;
      double z = this.nmsMob.dA() - this.nmsMob.N;
   ...
   public void playAnimation(@NotNull EntityAnimation anim) {
      ...
      case CRITICAL_DAMAGE:
         ...
         var3 = ChipUtil1_20_R4.fromNMS(this.nmsMob).getWorld().getPlayers().iterator();

         while(var3.hasNext()) {
            p = (Player)var3.next();
            ChipUtil1_20_R4.toNMS(p).c.b(pkt);
         }
   ...
   public boolean isInBubbleColumn() {
      return this.nmsMob.cN().a_(this.nmsMob.dp()).a(Blocks.nd);
   }

   public boolean isInvulnerableTo(@Nullable DamageCause cause) {
      return this.nmsMob.b(ChipUtil1_20_R4.toNMS((DamageCause)cause, (Entity)this.m));
   }
   ...
   public boolean isPushableBy(@Nullable Entity entity) {
      return IEntitySelector.a(ChipUtil1_20_R4.toNMS(entity)).test(ChipUtil1_20_R4.toNMS(entity));
   }
   ...
   public float getMaxUpStep() {
      return this.nmsMob.dJ();
   }

   public void setMaxUpStep(float maxUpStep) {
      this.nmsMob.eW().a(GenericAttributes.v).a((double)maxUpStep);
   }
   ...
   public void eat(@NotNull ItemStack item) {
      this.nmsMob.a(ChipUtil1_20_R4.toNMS(this.m.getWorld()), ChipUtil1_20_R4.toNMS(item));
   }

   public void setRotation(float yaw, float pitch) {
      try {
         if (this.m instanceof Slime) {
            ControllerMove moveControl = this.nmsMob.H();
