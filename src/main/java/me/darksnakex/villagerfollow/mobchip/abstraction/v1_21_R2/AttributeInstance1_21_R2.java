...
final class AttributeInstance1_21_R2 implements AttributeInstance {
   private final AttributeModifiable handle;
   private final Attribute a;

   public AttributeInstance1_21_R2(Attribute a, AttributeModifiable handle) {
      this.a = a;
      this.handle = handle;
   }
   ...
   public void removeModifier(@NotNull AttributeModifier mod) {
      Preconditions.checkArgument(mod != null, "modifier");
      this.handle.e(CraftAttributeInstance.convert(mod));
   }
   ...
   public double getDefaultValue() {
      return ((AttributeBase)this.handle.a().a()).a();
   }
}
