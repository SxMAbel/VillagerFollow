...
final class BehaviorResult1_19_R2 extends BehaviorResult {
   ...
   public <T extends EntityLiving> BehaviorResult1_19_R2(BehaviorControl<T> b, T mob) {
      this.b = b;
      this.mob = mob;
      this.l = ChipUtil1_19_R2.toNMS(Bukkit.getWorld(mob.s.getWorld().getUID()));
      b.e(this.l, mob, 0L);
   }

   @NotNull
   public BehaviorResult.Status getStatus() {
      return ChipUtil1_19_R2.fromNMS(this.b.a());
   }
