...
final class EntityNavigation1_21_R1 implements EntityNavigation {
   ...
   public EntityNavigation1_21_R1(Mob m) {
      this.handle = ChipUtil1_21_R1.toNMS(m).N();
   ...
   public NavigationPath buildPath() {
      if (this.points.isEmpty()) {
         ...
         return new NavigationPath1_21_R1(new PathEntity(this.toNodes(), (BlockPosition)null, true), this.m, (double)this.speedMod);
      }
   }
