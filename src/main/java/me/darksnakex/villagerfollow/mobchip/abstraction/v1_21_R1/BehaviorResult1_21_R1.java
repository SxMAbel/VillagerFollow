...
final class BehaviorResult1_21_R1 extends BehaviorResult {
   private final BehaviorControl b;
   private final EntityLiving mob;
   private final WorldServer l;

   public <T extends EntityLiving> BehaviorResult1_21_R1(BehaviorControl<T> b, T mob) {
      this.b = b;
      this.mob = mob;
      this.l = ChipUtil1_21_R1.toNMS(Bukkit.getWorld(mob.cN().getWorld().getUID()));
      b.e(this.l, mob, 0L);
   }

   @NotNull
   public BehaviorResult.Status getStatus() {
      return ChipUtil1_21_R1.fromNMS(this.b.a());
   }
