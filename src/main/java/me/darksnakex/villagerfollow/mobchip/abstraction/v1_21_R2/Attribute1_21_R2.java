...
final class Attribute1_21_R2 extends AttributeRanged implements Attribute {
   private final NamespacedKey key;
   private final double defaultV;
   private final double min;
   private final double max;

   public Attribute1_21_R2(AttributeRanged a) {
   ...
   public Attribute1_21_R2(NamespacedKey key, double defaultV, double min, double max, boolean clientSide) {
