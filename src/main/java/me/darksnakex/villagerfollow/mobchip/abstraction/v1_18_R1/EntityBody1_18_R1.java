...
final class EntityBody1_18_R1 implements EntityBody {
   ...
   public EntityBody.InteractionResult interact(@NotNull Player p, @Nullable EntityBody.InteractionHand hand) {
      ...
      switch(this.nmsMob.a(ChipUtil1_18_R1.toNMS(p), h)) {
      case a:
   ...
   public boolean isSensitiveToWater() {
      return this.nmsMob.eD();
   }

   public boolean isAffectedByPotions() {
      return this.nmsMob.eW();
   }

   public boolean isBlocking() {
      return this.nmsMob.eS();
   }
   ...
   public boolean isInvisibleTo(@Nullable Player p) {
      return this.nmsMob.c(ChipUtil1_18_R1.toNMS(p));
   }

   @NotNull
   public EntityBody.InteractionHand getMainHand() {
      return this.nmsMob.eK() == EnumMainHand.a ? EntityBody.InteractionHand.OFF_HAND : EntityBody.InteractionHand.MAIN_HAND;
   }
   ...
   public boolean isMoving() {
      double x = this.nmsMob.dc() - this.nmsMob.u;
      double z = this.nmsMob.di() - this.nmsMob.w;
   ...
   public void playAnimation(@NotNull EntityAnimation anim) {
      ...
      case CRITICAL_DAMAGE:
         ...
         var3 = ChipUtil1_18_R1.fromNMS(this.nmsMob).getWorld().getPlayers().iterator();

         while(var3.hasNext()) {
            p = (Player)var3.next();
            ChipUtil1_18_R1.toNMS(p).b.a(pkt);
         }
   ...
   public boolean isInBubbleColumn() {
      return this.nmsMob.t.a_(this.nmsMob.cW()).a(Blocks.lq);
   }

   public boolean isInvulnerableTo(@Nullable DamageCause cause) {
      return this.nmsMob.b(ChipUtil1_18_R1.toNMS(cause));
   }
   ...
   public boolean isPushableBy(@Nullable Entity entity) {
      return IEntitySelector.a(ChipUtil1_18_R1.toNMS(entity)).test(ChipUtil1_18_R1.toNMS(entity));
   }
   ...
   public void eat(@NotNull ItemStack item) {
      this.nmsMob.a(ChipUtil1_18_R1.toNMS(this.m.getWorld()), ChipUtil1_18_R1.toNMS(item));
   }
