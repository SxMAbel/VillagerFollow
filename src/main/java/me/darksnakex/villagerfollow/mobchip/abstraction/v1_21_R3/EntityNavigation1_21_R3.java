...
final class EntityNavigation1_21_R3 implements EntityNavigation {
   ...
   public EntityNavigation1_21_R3(Mob m) {
      this.handle = ChipUtil1_21_R3.toNMS(m).P();
   ...
   public NavigationPath buildPath() {
      if (this.points.isEmpty()) {
         ...
         return new NavigationPath1_21_R3(new PathEntity(this.toNodes(), (BlockPosition)null, true), this.m, (double)this.speedMod);
      }
   }
