...
final class NavigationPath1_18_R2 implements NavigationPath {
   ...
   public NavigationPath1_18_R2(@NotNull PathEntity nms, @NotNull Mob m, double speedMod) {
      this.m = m;
      ...
      try {
         ...
         this.nodes.addAll((Collection)pathPoints.stream().map(ChipUtil1_18_R2::fromNMS).collect(Collectors.toSet()));
   ...
   public void advance() {
      if (this.isDone()) {
         ...
         (new EntityController1_18_R2(this.m)).moveTo((double)n.a, (double)n.b, (double)n.c, this.speedMod);
         this.getHandle().a();
      }
   }
