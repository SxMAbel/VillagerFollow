...
final class EntityNavigation1_20_R4 implements EntityNavigation {
   ...
   public EntityNavigation1_20_R4(Mob m) {
      this.handle = ChipUtil1_20_R4.toNMS(m).K();
   ...
   public NavigationPath buildPath() {
      if (this.points.isEmpty()) {
         ...
         return new NavigationPath1_20_R4(new PathEntity(this.toNodes(), (BlockPosition)null, true), this.m, (double)this.speedMod);
      }
   }
