...
final class EntityGossipContainer1_21_R1 implements EntityGossipContainer {
   private final Reputation handle;
   private final Villager entity;

   public EntityGossipContainer1_21_R1(Villager v) {
      this.entity = v;
      this.handle = ((CraftVillager)v).getHandle().gF();
   }
