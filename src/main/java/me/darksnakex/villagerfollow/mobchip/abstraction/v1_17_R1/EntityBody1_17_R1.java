...
final class EntityBody1_17_R1 implements EntityBody {
   ...
   private void update() {
      PacketPlayOutEntityMetadata packet = new PacketPlayOutEntityMetadata(this.nmsMob.getId(), this.nmsMob.getDataWatcher(), true);
   ...
   public boolean isLeftHanded() {
      return this.nmsMob.isLeftHanded();
   }

   public void setLeftHanded(boolean leftHanded) {
      this.nmsMob.setLeftHanded(leftHanded);
   }
   ...
   public EntityBody.InteractionResult interact(@NotNull Player p, @Nullable EntityBody.InteractionHand hand) {
      ...
      switch(this.nmsMob.a(ChipUtil1_17_R1.toNMS(p), h)) {
      case a:
   ...
   public boolean isAffectedByPotions() {
      return this.nmsMob.eQ();
   }

   public boolean isBlocking() {
      return this.nmsMob.isBlocking();
   }
   ...
   public boolean isUsingItem() {
      return this.nmsMob.isHandRaised();
   }

   public boolean isFireImmune() {
      return this.nmsMob.isFireProof();
   }
   ...
   public boolean isInvisibleTo(@Nullable Player p) {
      return this.nmsMob.c(ChipUtil1_17_R1.toNMS(p));
   }

   @NotNull
   public EntityBody.InteractionHand getMainHand() {
      return this.nmsMob.getMainHand() == EnumMainHand.a ? EntityBody.InteractionHand.OFF_HAND : EntityBody.InteractionHand.MAIN_HAND;
   }
   ...
   public boolean isMoving() {
      double x = this.nmsMob.locX() - this.nmsMob.u;
      double z = this.nmsMob.locZ() - this.nmsMob.w;
   ...
   public void playAnimation(@NotNull EntityAnimation anim) {
      ...
      case CRITICAL_DAMAGE:
         ...
         var3 = ChipUtil1_17_R1.fromNMS(this.nmsMob).getWorld().getPlayers().iterator();
   ...
   public boolean isInBubbleColumn() {
      return this.nmsMob.t.getType(this.nmsMob.getChunkCoordinates()).a(Blocks.lq);
   }

   public boolean isInvulnerableTo(@Nullable DamageCause cause) {
      return this.nmsMob.isInvulnerable(ChipUtil1_17_R1.toNMS(cause));
   }
   ...
   public float getYaw() {
      return this.nmsMob.getYRot();
   }

   public void setYaw(float rotation) {
      this.nmsMob.setYRot(EntityBody.normalizeRotation(rotation));
   }

   public float getPitch() {
      return this.nmsMob.getXRot();
   }

   public void setPitch(float rotation) {
      this.nmsMob.setXRot(EntityBody.normalizeRotation(rotation));
   }
   ...
   public void sendTo(@NotNull Player p) {
      Packet<?> packet = this.nmsMob.getPacket();
      ((CraftPlayer)p).getHandle().b.sendPacket(packet);
   }
   ...
   public void eat(@NotNull ItemStack item) {
      this.nmsMob.a(ChipUtil1_17_R1.toNMS(this.m.getWorld()), ChipUtil1_17_R1.toNMS(item));
   }

   public void setRotation(float yaw, float pitch) {
      try {
         if (this.m instanceof Slime) {
            ControllerMove moveControl = this.nmsMob.getControllerMove();
