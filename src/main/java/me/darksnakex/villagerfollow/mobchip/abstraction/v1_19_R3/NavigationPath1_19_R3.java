...
final class NavigationPath1_19_R3 implements NavigationPath {
   private String name;
   private final Mob m;
   ...
   NavigationPath1_19_R3(@NotNull PathEntity nms, @NotNull Mob m, double speedMod) {
      this.m = m;
      ...
      try {
         ...
         this.nodes.addAll((Collection)pathPoints.stream().map(ChipUtil1_19_R3::fromNMS).collect(Collectors.toSet()));
   ...
   public void advance() {
      if (this.isDone()) {
         ...
         (new EntityController1_19_R3(this.m)).moveTo((double)n.a, (double)n.b, (double)n.c, this.speedMod);
         this.getHandle().a();
      }
   }
