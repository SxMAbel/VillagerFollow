...
final class EntityGossipContainer1_18_R2 implements EntityGossipContainer {
   private final Reputation handle;
   private final Villager entity;

   public EntityGossipContainer1_18_R2(Villager v) {
      this.entity = v;
      this.handle = ((CraftVillager)v).getHandle().fW();
   }
