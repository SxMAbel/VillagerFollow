...
final class EntityController1_20_R4 implements EntityController {
   ...
   public EntityController1_20_R4(Mob m) {
      EntityInsentient nms = ChipUtil1_20_R4.toNMS(m);
      this.lookC = nms.G();
      this.moveC = nms.H();
      this.jumpC = nms.I();
      this.m = m;
   ...
   public EntityController moveTo(double x, double y, double z, double speedMod) {
      ...
      this.moveC.a();
      this.nms.K().a(this.moveC.d(), this.moveC.e(), this.moveC.f(), this.moveC.c());
      this.nms.K().c();
      return this;
   }
