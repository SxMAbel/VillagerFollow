...
final class EntityBody1_19_R2 implements EntityBody {
   private final EntityInsentient nmsMob;
   private final Mob m;

   public EntityBody1_19_R2(Mob m) {
      this.m = m;
   ...
   public EntityBody.InteractionResult interact(@NotNull Player p, @Nullable EntityBody.InteractionHand hand) {
      ...
      switch(this.nmsMob.a(ChipUtil1_19_R2.toNMS(p), h)) {
      case a:
   ...
   public boolean isInvisibleTo(@Nullable Player p) {
      return this.nmsMob.c(ChipUtil1_19_R2.toNMS(p));
   }

   @NotNull
   public EntityBody.InteractionHand getMainHand() {
      return this.nmsMob.eY() == EnumMainHand.a ? EntityBody.InteractionHand.OFF_HAND : EntityBody.InteractionHand.MAIN_HAND;
   }
   ...
   public boolean isMoving() {
      double x = this.nmsMob.dk() - this.nmsMob.t;
      double z = this.nmsMob.dq() - this.nmsMob.v;
   ...
   public void playAnimation(@NotNull EntityAnimation anim) {
      ...
      case CRITICAL_DAMAGE:
         ...
         var3 = ChipUtil1_19_R2.fromNMS(this.nmsMob).getWorld().getPlayers().iterator();

         while(var3.hasNext()) {
            p = (Player)var3.next();
            ChipUtil1_19_R2.toNMS(p).b.a(pkt);
         }
   ...
   public boolean isInBubbleColumn() {
      return this.nmsMob.s.a_(this.nmsMob.df()).a(Blocks.mB);
   }

   public boolean isInvulnerableTo(@Nullable DamageCause cause) {
      return this.nmsMob.b(ChipUtil1_19_R2.toNMS((DamageCause)cause, (Entity)this.m));
   }
   ...
   public boolean isPushableBy(@Nullable Entity entity) {
      return IEntitySelector.a(ChipUtil1_19_R2.toNMS(entity)).test(ChipUtil1_19_R2.toNMS(entity));
   }
   ...
   public void setPitch(float rotation) {
      this.nmsMob.q(EntityBody.normalizeRotation(rotation));
   }
   ...
   public void eat(@NotNull ItemStack item) {
      this.nmsMob.a(ChipUtil1_19_R2.toNMS(this.m.getWorld()), ChipUtil1_19_R2.toNMS(item));
   }

   public void setRotation(float yaw, float pitch) {
      try {
         if (this.m instanceof Slime) {
            ControllerMove moveControl = this.nmsMob.B();
