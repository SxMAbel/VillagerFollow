...
final class EntityNavigation1_18_R1 implements EntityNavigation {
   ...
   public EntityNavigation1_18_R1(Mob m) {
      this.handle = ChipUtil1_18_R1.toNMS(m).D();
   ...
   public NavigationPath buildPath() {
      if (this.points.isEmpty()) {
         ...
         return new NavigationPath1_18_R1(new PathEntity(this.toNodes(), (BlockPosition)null, true), this.m, (double)this.speedMod);
      }
   }
