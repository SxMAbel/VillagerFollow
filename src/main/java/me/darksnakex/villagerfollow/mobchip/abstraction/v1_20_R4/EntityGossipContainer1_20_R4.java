...
final class EntityGossipContainer1_20_R4 implements EntityGossipContainer {
   private final Reputation handle;
   private final Villager entity;

   public EntityGossipContainer1_20_R4(Villager v) {
      this.entity = v;
      this.handle = ((CraftVillager)v).getHandle().gL();
   }
