...
final class EntityBody1_20_R3 implements EntityBody {
   private final EntityInsentient nmsMob;
   private final Mob m;

   public EntityBody1_20_R3(Mob m) {
      this.m = m;
      this.nmsMob = ChipUtil1_20_R3.toNMS(m);
   }

   private void update() {
      PacketPlayOutEntityMetadata packet = new PacketPlayOutEntityMetadata(this.nmsMob.aj(), this.nmsMob.an().b());
   ...
   public EntityBody.InteractionResult interact(@NotNull Player p, @Nullable EntityBody.InteractionHand hand) {
      ...
      switch(this.nmsMob.a(ChipUtil1_20_R3.toNMS(p), h)) {
      case a:
   ...
   public boolean isInvisibleTo(@Nullable Player p) {
      return this.nmsMob.d(ChipUtil1_20_R3.toNMS(p));
   }

   @NotNull
   public EntityBody.InteractionHand getMainHand() {
      return this.nmsMob.fm() == EnumMainHand.a ? EntityBody.InteractionHand.OFF_HAND : EntityBody.InteractionHand.MAIN_HAND;
   }
   ...
   public boolean isInCombat() {
      try {
         ...
         return inCombatF.getBoolean(this.nmsMob.bO);
   ...
   public boolean isMoving() {
      double x = this.nmsMob.dr() - this.nmsMob.K;
      double z = this.nmsMob.dx() - this.nmsMob.M;
   ...
   public void playAnimation(@NotNull EntityAnimation anim) {
      ...
      case CRITICAL_DAMAGE:
         ...
         var3 = ChipUtil1_20_R3.fromNMS(this.nmsMob).getWorld().getPlayers().iterator();

         while(var3.hasNext()) {
            p = (Player)var3.next();
            ChipUtil1_20_R3.toNMS(p).c.b(pkt);
         }
   ...
   public boolean isInBubbleColumn() {
      return this.nmsMob.cK().a_(this.nmsMob.dm()).a(Blocks.nd);
   }

   public boolean isInvulnerableTo(@Nullable DamageCause cause) {
      return this.nmsMob.b(ChipUtil1_20_R3.toNMS((DamageCause)cause, (Entity)this.m));
   }

   public int getMaxFallDistance() {
      return this.nmsMob.cu();
   }

   public boolean isPushableBy(@Nullable Entity entity) {
      return IEntitySelector.a(ChipUtil1_20_R3.toNMS(entity)).test(ChipUtil1_20_R3.toNMS(entity));
   }
   ...
   public void eat(@NotNull ItemStack item) {
      this.nmsMob.a(ChipUtil1_20_R3.toNMS(this.m.getWorld()), ChipUtil1_20_R3.toNMS(item));
   }
