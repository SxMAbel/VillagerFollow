...
final class EntityNavigation1_21_R5 implements EntityNavigation {
   ...
   public EntityNavigation1_21_R5(Mob m) {
      this.handle = ChipUtil1_21_R5.toNMS(m).S();
   ...
   public NavigationPath buildPath() {
      if (this.points.isEmpty()) {
         ...
         return new NavigationPath1_21_R5(new PathEntity(this.toNodes(), (BlockPosition)null, true), this.m, (double)this.speedMod);
      }
   }
