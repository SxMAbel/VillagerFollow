...
final class EntityBody1_21_R2 implements EntityBody {
   private final EntityInsentient nmsMob;
   private final Mob m;

   public EntityBody1_21_R2(Mob m) {
      this.m = m;
   ...
   public EntityBody.InteractionResult interact(@NotNull Player p, @Nullable EntityBody.InteractionHand hand) {
      ...
      EnumInteractionResult result = this.nmsMob.a(ChipUtil1_21_R2.toNMS(p), h);
   ...
   public boolean isInvisibleTo(@Nullable Player p) {
      return this.nmsMob.d(ChipUtil1_21_R2.toNMS(p));
   }
   ...
   public boolean isMoving() {
      double x = this.nmsMob.dB() - this.nmsMob.K;
      double z = this.nmsMob.dH() - this.nmsMob.M;
   ...
   public void playAnimation(@NotNull EntityAnimation anim) {
      ...
      case CRITICAL_DAMAGE:
         ...
         var3 = ChipUtil1_21_R2.fromNMS(this.nmsMob).getWorld().getPlayers().iterator();

         while(var3.hasNext()) {
            p = (Player)var3.next();
            ChipUtil1_21_R2.toNMS(p).f.b(pkt);
         }
   ...
   public boolean isInBubbleColumn() {
      return this.nmsMob.cU().a_(this.nmsMob.dw()).a(Blocks.ny);
   }

   public boolean isInvulnerableTo(@Nullable DamageCause cause) {
      return this.nmsMob.a(this.nmsMob.dW().getMinecraftWorld(), ChipUtil1_21_R2.toNMS((DamageCause)cause, (Entity)this.m));
   }
   ...
   public boolean isPushableBy(@Nullable Entity entity) {
      return IEntitySelector.a(ChipUtil1_21_R2.toNMS(entity)).test(ChipUtil1_21_R2.toNMS(entity));
   }

   public float getYaw() {
      return this.nmsMob.dM();
   }
   ...
   public void setMaxUpStep(float maxUpStep) {
      this.nmsMob.eY().a(GenericAttributes.B).a((double)maxUpStep);
   }
   ...
   public void sendTo(@NotNull Player p) {
      EntityTracker tracked = (EntityTracker)((WorldServer)this.nmsMob.dW()).m().a.K.get(this.nmsMob.ar());
   ...
   public void eat(@NotNull ItemStack item) {
      this.nmsMob.dW().a((EntityHuman)null, this.nmsMob.dB(), this.nmsMob.dD(), this.nmsMob.dH(), SoundEffects.kx, this.nmsMob.dn(), 1.0F, 1.0F);
