...
final class EntityBody1_21_R3 implements EntityBody {
   private final EntityInsentient nmsMob;
   private final Mob m;

   public EntityBody1_21_R3(Mob m) {
      this.m = m;
   ...
   public EntityBody.InteractionResult interact(@NotNull Player p, @Nullable EntityBody.InteractionHand hand) {
      ...
      EnumInteractionResult result = this.nmsMob.a(ChipUtil1_21_R3.toNMS(p), h);
   ...
   public boolean isInvisibleTo(@Nullable Player p) {
      return this.nmsMob.d(ChipUtil1_21_R3.toNMS(p));
   }
   ...
   public boolean isInCombat() {
      try {
         ...
         return inCombatF.getBoolean(this.nmsMob.bS);
   ...
   public void playAnimation(@NotNull EntityAnimation anim) {
      ...
      case CRITICAL_DAMAGE:
         ...
         var3 = ChipUtil1_21_R3.fromNMS(this.nmsMob).getWorld().getPlayers().iterator();

         while(var3.hasNext()) {
            p = (Player)var3.next();
            ChipUtil1_21_R3.toNMS(p).f.b(pkt);
         }
   ...
   public boolean isInBubbleColumn() {
      return this.nmsMob.cU().a_(this.nmsMob.dv()).a(Blocks.nF);
   }

   public boolean isInvulnerableTo(@Nullable DamageCause cause) {
      return this.nmsMob.a(this.nmsMob.dV().getMinecraftWorld(), ChipUtil1_21_R3.toNMS((DamageCause)cause, (Entity)this.m));
   }
   ...
   public boolean isPushableBy(@Nullable Entity entity) {
      return IEntitySelector.a(ChipUtil1_21_R3.toNMS(entity)).test(ChipUtil1_21_R3.toNMS(entity));
   }
   ...
   public void sendTo(@NotNull Player p) {
      EntityTracker tracked = (EntityTracker)((WorldServer)this.nmsMob.dV()).m().a.K.get(this.nmsMob.ar());
   ...
   public void eat(@NotNull ItemStack item) {
      this.nmsMob.dV().a((EntityHuman)null, this.nmsMob.dA(), this.nmsMob.dC(), this.nmsMob.dG(), SoundEffects.kD, this.nmsMob.dm(), 1.0F, 1.0F);
   ...
   public void setRotation(float yaw, float pitch) {
      try {
         if (this.m instanceof Slime) {
            ControllerMove moveControl = this.nmsMob.N();
